...
public class DataLoader {
	...
	private void loadData(){
		...
		// create an author
		Author dv = new Author("Ahmed","Raza","raza@gmail.com");
	...
	private void createAuthors() {
		Author jv = new Author("Brown","Bisht","bisht@bb.com");
		authorRepository.save(jv);
		Author av = new Author("Rishab","Omar","omar@ro.com");
		authorRepository.save(av);
		Author kv = new Author("Bharat","Gupta","gupta@bg.com");
	...
	private void createPosts(Author author) {
		...
		Post grails = new Post("Boot is awesome!");
		grails.setSlug("boot-is-awesome");
